...
/**
 * The sun and the moon, exported because the statistics card labels its rows with the
 * same two. Two icons for the same two blocks, drawn differently on two cards, is a
 * household having to learn the same thing twice.
 */
export const BLOCK_ICONS: Record<RoutineBlock, string> = {
